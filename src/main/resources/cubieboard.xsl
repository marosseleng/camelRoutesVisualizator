...
<svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid meet" zoomAndPan="disable" transform="" id="svg2" version="1.1">
...
<!--BOARD-->
<rect x="0" y="0" stroke="black" id="board" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="600" height="400" fill="black" rx="30" ry="30" />
<circle id="e2_circle" cx="570" cy="25" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="18" fill="khaki" transform="" />
<circle cx="570" cy="373" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="18" fill="khaki" transform="" id="e3_circle" />
<circle cx="128" cy="373" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="18" fill="khaki" transform="" id="e4_circle" />
<circle cx="128" cy="25" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="18" fill="khaki" transform="" id="e5_circle" />
<circle id="e6_circle" cx="128" cy="25" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="9" fill="white" transform="" />
<circle cx="570" cy="25" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="9" fill="white" transform="" id="e7_circle" />
<circle cx="570" cy="373" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="9" fill="white" transform="" id="e8_circle" />
<circle cx="128" cy="373" stroke="black" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" r="9" fill="white" transform="" id="e9_circle" />
<!--UPPER PINS-->
<rect x="230" y="9" id="upper_pins_board" style="fill:#000000;stroke:#ffffff;stroke-width:1px" width="322" height="31" rx="0" ry="0" />
...
<!--LOWER PINS-->
<rect x="230" y="357" id="lower_pins_board" style="fill:#000000;stroke:#ffffff;stroke-width:1px" width="322" height="31" rx="0" ry="0" />
...
<!--PORTS AND TEXT-->
<rect x="151" y="9" stroke="white" id="sata" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="69" height="30" fill="black" rx="0" ry="0" />
<text fill="white" x="156" y="27" id="sata_text" style="font-family: serif; font-size: 10px;">SATA DATA</text>
<rect x="504" y="238" stroke="white" id="ethernet" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="97" height="98" fill="dimgray" />
<text fill="white" x="534" y="288" id="ethernet_text" style="font-family: serif; font-size: 12px;">Ethernet</text>
<rect x="150" y="295" stroke="white" id="USB1_USB2" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="77" height="104" fill="dimgray" rx="0" ry="0" />
<text fill="white" x="158" y="324" id="e64_texte" style="font-family: serif; font-size: 12px;">USB 1</text>
<text fill="white" x="158" y="343" style="font-family: serif; font-size: 12px;" id="e65_texte" transform="">USB 2</text>
<rect x="538" y="176" stroke="white" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="62" height="46" fill="dimgray" id="e67_rect" rx="0" ry="0" />
<rect x="514" y="124" stroke="white" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="108" height="25" rx="0" ry="0" id="audio" fill="black" />
<text fill="white" x="543" y="141" id="e69_texte" style="font-family: serif; font-size: 14px;">Audio</text>
<rect x="27" y="312" stroke="white" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="82" height="88" fill="dimgray" id="data_card" rx="0" ry="0" />
<text fill="white" x="29" y="350" id="e71_texte" style="font-family: serif; font-size: 14px;">DATA CARD</text>
<rect x="1" y="142" stroke="white" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="82" height="88" fill="dimgray" rx="0" ry="0" id="e72_card" />
<text fill="white" x="544" y="205" id="e73_texte" style="font-family: serif; font-size: 14px;">miniUSB</text>
<text fill="white" x="17" y="184" id="e74_texte" style="font-family: serif; font-size: 14px;">HDMI</text>
<rect x="102" y="59" stroke="white" id="sata_power" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="28" height="26" fill="white" />
<text fill="white" x="85" y="98" id="e76_texte" style="font-family: serif; font-size: 10px;">SATA POWER</text>
<rect x="1" y="75" stroke="white" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="23" height="47" fill="white" rx="0" ry="0" id="power_butt" />
<text fill="#000000" x="-82" y="-115" id="e79_texte" style="font-family: serif; font-size: 12px;" transform="matrix(0 -1 1 0 133.016 37.4208)">POWER</text>
<rect x="1" y="23" stroke="white" style="stroke-width: 1px; vector-effect: non-scaling-stroke;" width="62" height="46" fill="dimgray" rx="0" ry="0" id="e80_rect" />
